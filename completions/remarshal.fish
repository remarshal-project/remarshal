...
complete -c remarshal -l yaml-expand-aliases -d "Expand YAML aliases (disable anchor/alias generation)"
...
complete -c remarshal -l starlark -x -d "Transform the data with a Starlark expression or program"
complete -c remarshal -l starlark-file -r -d "Read a Starlark program from a file"
complete -c remarshal -l starlark-max-allocs -x -d "Maximum cumulative bytes of Starlark allocations"
complete -c remarshal -l starlark-max-steps -x -d "Maximum number of Starlark interpreter steps"
