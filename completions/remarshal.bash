_remarshal() {
    ...
    opts='--help --version --expand-aliases --from --if --input-format --input --indent --stringify --max-values --multiline --output --sort-keys --to --of --output-format --unwrap --verbose --width --wrap --yaml-style --yaml-style-newline'
