_remarshal() {
    ...
    opts='-h --help -v --version -f --from --if --input-format -i --input --indent -k --stringify --max-values --multiline -o --output -s --sort-keys --starlark --starlark-file --starlark-max-allocs --starlark-max-steps -t --to --of --output-format --unwrap --verbose --width --wrap --yaml-expand-aliases --yaml-style --yaml-style-newline --yaml-tags'
